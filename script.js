const projects = [
  {
    ...
    title: "内容落地",
    subtitle: "内容案例 · 内容策划",
    lead: "把组织内容、活动物料与用户反馈整理为可阅读、可传播、可复盘的内容案例。",
    prefix: "portfolio",
    pages: 11,
    pageNumbers: [2, 3, 6, 7, 8, 9, 10, 11],
    tags: ["内容案例", "视觉物料", "内容策划", "用户反馈"],
    notes: [
      ["案例语境", "围绕组织内容、活动物料与用户反馈，呈现从选题判断到内容落地的案例整理。"],
      ["我的工作", "负责内容架构、选题梳理、文案打磨、资料整理与视觉呈现。"],
      ["策划转化", "将活动、产品和社群信息转化为图文、视觉物料、Demo 与视频内容案例。"],
